...
proc isBadRedirect(map: FingerMap, row0, col0, row1, col1, row2, col2: uint8): bool =
  ...
  isRedirect(map, row0, col0, row1, col1, row2, col2) and f1.get notin {LI, RI} and
    f2.get notin {LI, RI} and f3.get notin {LI, RI}
...
proc isRollIn(map: FingerMap, row0, col0, row1, col1, row2, col2: uint8): bool =
  ...
  isRoll(map, row0, col0, row1, col1, row2, col2) and (
    (
      isSameHandBi(map, row0, col0, row1, col1) and getHand(f1) == some(Left) and
      ord(f1.get) < ord(f2.get)
    ) or (
      isSameHandBi(map, row1, col1, row2, col2) and getHand(f2) == some(Left) and
      ord(f2.get) < ord(f3.get)
    ) or (
      isSameHandBi(map, row0, col0, row1, col1) and getHand(f1) == some(Right) and
      ord(f1.get) > ord(f2.get)
    ) or (
      isSameHandBi(map, row1, col1, row2, col2) and getHand(f2) == some(Right) and
      ord(f2.get) > ord(f3.get)
    )
  )
...
proc isSameRowAlt(map: FingerMap, row0, col0, row1, col1, row2, col2: uint8): bool =
  isAlt(map, row0, col0, row1, col1, row2, col2) and isSameRowBi(row0, col0, row2, col2)
...
proc isSameRowAdjacentFingerAlt(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isAlt(map, row0, col0, row1, col1, row2, col2) and isSameRowBi(row0, col0, row2, col2) and
    isAdjacentFingerBi(map, row0, col0, row2, col2)

proc isSameRowAdjacentFingerAltIn(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isSameRowAdjacentFingerAlt(map, row0, col0, row1, col1, row2, col2) and
    isRollIn(map, row0, col0, row2, col2, row1, col1)

proc isSameRowAdjacentFingerAltOut(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isSameRowAdjacentFingerAlt(map, row0, col0, row1, col1, row2, col2) and
...
proc isAdjacentFingerOneHand(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isOneHand(map, row0, col0, row1, col1, row2, col2) and
    isAdjacentFingerTri(map, row0, col0, row1, col1, row2, col2)

proc isAdjacentFingerOneHandIn(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isOneHandIn(map, row0, col0, row1, col1, row2, col2) and
    isAdjacentFingerTri(map, row0, col0, row1, col1, row2, col2)

proc isAdjacentFingerOneHandOut(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isOneHandOut(map, row0, col0, row1, col1, row2, col2) and
    isAdjacentFingerTri(map, row0, col0, row1, col1, row2, col2)
...
proc isSameRowAdjacentFingerOneHand(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isOneHand(map, row0, col0, row1, col1, row2, col2) and
...
proc isSameRowAdjacentFingerOneHandIn(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isOneHandIn(map, row0, col0, row1, col1, row2, col2) and
    isSameRowModTri(map, row0, col0, row1, col1, row2, col2) and
...
proc isSameRowAdjacentFingerOneHandOut(
    map: FingerMap, row0, col0, row1, col1, row2, col2: uint8
): bool =
  isOneHandOut(map, row0, col0, row1, col1, row2, col2) and
    isSameRowModTri(map, row0, col0, row1, col1, row2, col2) and
...
proc isSameRowRoll(map: FingerMap, row0, col0, row1, col1, row2, col2: uint8): bool =
  isRoll(map, row0, col0, row1, col1, row2, col2) and (
    (
      isSameHandBi(map, row0, col0, row1, col1) and
      isSameRowModBi(map, row0, col0, row1, col1)
    ) or (
      isSameHandBi(map, row1, col1, row2, col2) and
