...
proc isBadSameFingerSkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
  isSameFingerSkip(map, skip, row0, col0, row1, col1) and
  abs(row0.int - row1.int) == 2

proc isBadLeftPinkySkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
...
proc isBadLeftMiddleSkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
  isLeftMiddleSkip(map, skip, row0, col0, row1, col1) and
  abs(row0.int - row1.int) == 2

proc isBadLeftIndexSkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
  isLeftIndexSkip(map, skip, row0, col0, row1, col1) and
  abs(row0.int - row1.int) == 2

proc isBadRightIndexSkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
  isRightIndexSkip(map, skip, row0, col0, row1, col1) and
  abs(row0.int - row1.int) == 2

proc isBadRightMiddleSkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
  isRightMiddleSkip(map, skip, row0, col0, row1, col1) and
  abs(row0.int - row1.int) == 2

proc isBadRightRingSkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
  isRightRingSkip(map, skip, row0, col0, row1, col1) and
  abs(row0.int - row1.int) == 2

proc isBadRightPinkySkip(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
  isRightPinkySkip(map, skip, row0, col0, row1, col1) and
  abs(row0.int - row1.int) == 2

# Convenience functions for pattern checking
proc hasFingerSkipPattern(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
...
proc hasBadFingerSkipPattern(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): bool =
...
proc getAllSkipPatterns(map: FingerMap, skip: int, row0, col0, row1, col1: uint8): tuple[
  normal: seq[Finger],
  bad: seq[Finger]
] =
  result.normal = @[]
