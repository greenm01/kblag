...
proc isIndexStretchBi(map: FingerMap, row0, col0, row1, col1: uint8): bool =
  ...
  (f1.get == LM and col1 == 5'u8) or
  (f2.get == LM and col0 == 5'u8) or
  (f1.get == RM and col1 == 6'u8) or
  (f2.get == RM and col0 == 6'u8)
...
proc isPinkyStretchBi(map: FingerMap, row0, col0, row1, col1: uint8): bool =
  ...
  (f1.get == LR and col1 == 0'u8) or
  (f2.get == LR and col1 == 0'u8) or
  (f1.get == RR and col1 == 11'u8) or
  (f2.get == RR and col1 == 11'u8)
