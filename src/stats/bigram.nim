type BiOperation = proc(map: FingerMap, row0, col0, row1, col1: uint8): bool {.closure.}
...
proc processBigram(
  ...
  var biStat = BiStat(ngrams: newSeq[PackedBi](), weight: -Inf)
...
proc initializeBigramStats(map: FingerMap) =
  ...
  let badFingerStatNames: array[8, string] = [
    "Bad Left Pinky Bigram", "Bad Left Ring Bigram", "Bad Left Middle Bigram",
    "Bad Left Index Bigram", "Bad Right Index Bigram", "Bad Right Middle Bigram",
    "Bad Right Ring Bigram", "Bad Right Pinky Bigram",
  ]
