...
proc readFingerMap(path: string): FingerMap =
  ...
  try:
    ...
    raise
      newException(JsonParsingError, "Invalid JSON in finger map config: " & configPath)

  if not config.hasKey("fingerAssignments"):
    raise
      newException(ValueError, "Missing 'fingerAssignments' in config: " & configPath)
  ...
  if assignments.len != Row.int:
    raise newException(
      ValueError, "Expected " & $Row.int & " rows, got " & $assignments.len
    )
  ...
  for row in 0 ..< Row.int:
    if assignments[row].len != Col.int:
      raise newException(
        ValueError,
        "Row " & $row & " expected " & $Col.int & " columns, got " &
          $assignments[row].len,
      )
...
proc updateStats[T](
    stats: var Table[string, T], name: string, weights: openArray[float]
) =
  if name in stats:
    var stat = stats[name]
    when T is SkipStat:
...
proc readWeights(weightName: string) =
  ...
  for line in file.lines:
    ...
    if not (
      name in monoStats or name in biStats or name in triStats or name in quadStats or
...
proc fingerSortKey(name: string): int =
  ...
  of "left ring usage":
    2
  of "left middle usage":
    3
  of "left index usage":
    4
  of "left inner usage":
    5
  of "right inner usage":
    6
  of "right index usage":
    7
  of "right middle usage":
    8
  of "right ring usage":
    9
  of "right pinky usage":
    10
  of "right outer usage":
    11
  of "left hand usage":
    12
  of "right hand usage":
  ...
  of "same finger bigram":
    17
  of "left pinky bigram":
    18
  of "left ring bigram":
    19
  of "left middle bigram":
    20
  of "left index bigram":
    21
  of "right index bigram":
    22
  of "right middle bigram":
    23
  of "right ring bigram":
    24
  of "right pinky bigram":
    25
  of "bad same finger bigram":
    26
  of "bad left pinky bigram":
    27
  of "bad left ring bigram":
    28
  of "bad left middle bigram":
    29
  of "bad left index bigram":
    30
  of "bad right index bigram":
    31
  of "bad right middle bigram":
    32
  of "bad right ring bigram":
    33
  of "bad right pinky bigram":
    34
  of "full russor bigram":
    35
  of "half russor bigram":
    36
  of "index stretch bigram":
    37
  of "pinky stretch bigram":
    38

  # Trigrams through Quadgrams - matches middle section
  of "same finger trigram":
    39
  of "redirect":
    40
  of "bad redirect":
  ...
  of "alternation out":
    44
  of "same row alternation":
    45
  of "same row alternation in":
    46
  of "same row alternation out":
    47
  of "adjacent finger alternation":
    48
  of "adjacent finger alternation in":
    49
  of "adjacent finger alternation out":
    50
  of "same row adjacent finger alternation":
    51
  of "same row adjacent finger alternation in":
    52
  of "same row adjacent finger alternation out":
    53
  of "one hand":
    54
  of "one hand in":
  ...
  of "one hand out":
    56
  of "same row one hand":
    57
  of "same row one hand in":
    58
  of "same row one hand out":
    59
  of "adjacent finger one hand":
    60
  of "adjacent finger one hand in":
    61
  of "adjacent finger one hand out":
    62
  of "same row adjacent finger one hand":
    63
  of "same row adjacent finger one hand in":
    64
  of "same row adjacent finger one hand out":
    65
  of "roll":
    66
  of "roll in":
  ...
  of "same row roll in":
    70
  of "same row roll out":
    71
  of "adjacent finger roll":
    72
  of "adjacent finger roll in":
    73
  of "adjacent finger roll out":
    74
  of "same row adjacent finger roll":
    75
  of "same row adjacent finger roll in":
    76
  of "same row adjacent finger roll out":
    77
  of "same finger quadgram":
    78
  of "chained redirect":
    79
  of "bad chained redirect":
    80
  of "chained alternation":
    81
  of "chained alternation in":
    82
  of "chained alternation out":
    83
  of "chained alternation mix":
    84
  of "same row chained alternation":
    85
  of "same row chained alternation in":
    86
  of "same row chained alternation out":
    87
  of "same row chained alternation mix":
    88
  of "adjacent finger chained alternation":
    89
  of "adjacent finger chained alternation in":
    90
  of "adjacent finger chained alternation out":
    91
  of "adjacent finger chained alternation mix":
    92
  of "same row adjacent finger chained alternation":
    93
  of "same row adjacent finger chained alternation in":
    94
  of "same row adjacent finger chained alternation out":
    95
  of "same row adjacent finger chained alternation mix":
    96
  of "quad one hand":
    97
  of "quad one hand in":
    98
  of "quad one hand out":
    99
  of "quad same row one hand":
    100
  of "quad same row one hand in":
    101
  of "quad same row one hand out":
    102
  of "quad adjacent finger one hand":
    103
  of "quad adjacent finger one hand in":
    104
  of "quad adjacent finger one hand out":
    105
  of "quad same row adjacent finger one hand":
    106
  of "quad same row adjacent finger one hand in":
    107
  of "quad same row adjacent finger one hand out":
    108
  of "quad roll":
    109
  of "quad roll in":
  ...
  of "quad roll out":
    111
  of "quad same row roll":
    112
  of "quad same row roll in":
    113
  of "quad same row roll out":
    114
  of "quad adjacent finger roll":
    115
  of "quad adjacent finger roll in":
    116
  of "quad adjacent finger roll out":
    117
  of "quad same row adjacent finger roll":
    118
  of "quad same row adjacent finger roll in":
    119
  of "quad same row adjacent finger roll out":
    120
  of "true roll":
    121
  of "true roll in":
  ...
  of "true roll out":
    123
  of "same row true roll":
    124
  of "same row true roll in":
    125
  of "same row true roll out":
    126
  of "adjacent finger true roll":
    127
  of "adjacent finger true roll in":
    128
  of "adjacent finger true roll out":
    129
  of "same row adjacent finger true roll":
    130
  of "same row adjacent finger true roll in":
    131
  of "same row adjacent finger true roll out":
    132
  of "chained roll":
    133
  of "chained roll in":
  ...
  of "chained roll mix":
    136
  of "same row chained roll":
    137
  of "same row chained roll in":
    138
  of "same row chained roll out":
    139
  of "same row chained roll mix":
    140
  of "adjacent finger chained roll":
    141
  of "adjacent finger chained roll in":
    142
  of "adjacent finger chained roll out":
    143
  of "adjacent finger chained roll mix":
    144
  of "same row adjacent finger chained roll":
    145
  of "same row adjacent finger chained roll in":
    146
  of "same row adjacent finger chained roll out":
    147
  of "same row adjacent finger chained roll mix":
    148

  # Skipgrams - matches final section before Hand Balance
  of "same finger skipgram":
    149
  of "left pinky skipgram":
    150
  of "left ring skipgram":
    151
  of "left middle skipgram":
    152
  of "left index skipgram":
    153
  of "right index skipgram":
    154
  of "right middle skipgram":
    155
  of "right ring skipgram":
    156
  of "right pinky skipgram":
    157
  of "bad same finger skipgram":
    158
  of "bad left pinky skipgram":
    159
  of "bad left ring skipgram":
    160
  of "bad left middle skipgram":
    161
  of "bad left index skipgram":
    162
  of "bad right index skipgram":
    163
  of "bad right middle skipgram":
    164
  of "bad right ring skipgram":
    165
  of "bad right pinky skipgram":
    166
  ...
  of "hand balance":
    ...
    1000 # Everything else alphabetically
